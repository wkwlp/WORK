...
#     return event_days
#
# def send_reminder_email(event_days_soon):
#     """
#     通过PushPlus服务发送邮件提醒。
#
#     :param event_days_soon: list of tuples, 包含名字、日期、阳历日期和天数的元组列表 [(名字, 日期, 阳历日期, 天数), ...]
#     :return: None
#     """
#     # 设置本机环境系统变量，cmd
...
#             event_days_soon.append((name, date, solar_date, days_until_birthday))
#
#     # 如果有未来七天内的事件，则发送邮件提醒
#     if event_days_soon:
#         send_reminder_email(event_days_soon)
#     else:
#         print('未来七天内未有事件')
#
#
